...
- 当前筛选内置方法为 `b1`、`dribull` 和 `hcr`
- `review` 命名空间仍保留 `b2`，且 `review --method dribull` 复用现有 `b2` reviewer 与 `prompt-b2.md`
